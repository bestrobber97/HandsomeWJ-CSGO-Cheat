...
//[junk_enable /]
	...
	void ClanTag()
	{
		...
		case 2:
		{
			SetMyClanTag("NOOB.CJH", "NOOB.CJH");
			break;
		}
		case 3:
		{
			SetMyClanTag("NOOB.CJH \r", "NOOB.CJH");
			break;
		}
		case 4:
		{
			SetMyClanTag("pro.nwj", "pro.nwj");
			break;
		}
		case 5:
		{
			SetMyClanTag("pro.nwj \r", "pro.nwj");
			break;
		}
		case 6:
		{
			...
			int value = ServerTime % 16;
			switch (value)
			{
			case 0:
			{
				SetMyClanTag("N", "NOOB.CJH");
				break;
			}
			case 1:
			{
				SetMyClanTag("NO", "NOOB.CJH");
				break;
			}
			case 2:
			{
				SetMyClanTag("NOO", "NOOB.CJH");
				break;
			}
			case 3:
			{
				SetMyClanTag("NOOB", "NOOB.CJH");
				break;
			}
			case 4:
			{
			...
			case 5:
			{
				SetMyClanTag("NOOB.C", "NOOB.CJH");
				break;
			}
			case 6:
			{
				SetMyClanTag("NOOB.CJ", "NOOB.CJH");
				break;
			}
			case 7:
			{
	...
	{
		std::vector<std::string> chatspam = { "noob.cjh | pro.nwj" };
	...
	void ChatSpamRandom()
	{
		std::vector<std::string> chatspamsss = { "noob.cjh | I am HANDSOME" , "I'm HANDSOME" , "I AM FCKING HANDSOME","I AM SO FKING HANDSOME" };
